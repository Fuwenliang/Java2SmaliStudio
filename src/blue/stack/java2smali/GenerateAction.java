package blue.stack.java2smali;

/**
 * Created by thinkinbunny on 3/13/15.
 */
...
public class GenerateAction extends AnAction {
    ...
    public void actionPerformed(AnActionEvent e) {
        ...
        CompilerCallback compilerCallback = new CompilerCallback(javaFile,module);
    ...
    private static class CompilerCallback implements CompileStatusNotification {
        ...
        public CompilerCallback(PsiJavaFile javaFile, Module module) {
        ...
        public void finished(boolean b, int i, int i2, CompileContext compileContext) {
            VirtualFile outputDirectories = compileContext.getModuleOutputDirectory(module);
            if (outputDirectories != null ) {
                String compileDirPath =outputDirectories.getPath();
